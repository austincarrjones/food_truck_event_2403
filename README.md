...
pry(main)> require './lib/food_truck' #done
#=> true

pry(main)> item1 = Item.new({name: 'Peach Pie (Slice)', price: "$3.75"}) #done
#=> #<Item:0x007f9c56740d48...>

pry(main)> item2 = Item.new({name: 'Apple Pie (Slice)', price: '$2.50'}) #done
...
pry(main)> food_truck = FoodTruck.new("Rocky Mountain Pies") #done
#=> #<FoodTruck:0x00007f85683152f0...>

pry(main)> food_truck.name #done
#=> "Rocky Mountain Pies"

pry(main)> food_truck.inventory #done
#=> {}

pry(main)> food_truck.check_stock(item1) #done
#=> 0

pry(main)> food_truck.stock(item1, 30) #done
...
pry(main)> food_truck.stock(item1, 25) #done

pry(main)> food_truck.check_stock(item1) #done
#=> 55

pry(main)> food_truck.stock(item2, 12) #done
